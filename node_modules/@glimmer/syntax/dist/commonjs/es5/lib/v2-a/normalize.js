...
function normalize(source, options) {
  ...
  var top = _symbolTable.SymbolTable.top(normalizeOptions.strictMode ? normalizeOptions.locals : [], (_a = // eslint-disable-next-line @typescript-eslint/unbound-method
